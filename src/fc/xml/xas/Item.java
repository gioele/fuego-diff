...
/**
 * A piece of XML. The core item types each correspond to pieces of actual XML syntax. Extension
 * items may provide other interpretations, since they are allowed to define their own processing.
 * Item types are represented as subclasses, so there is little common functionality in this class.
 */
